            ...
            if (temp && temp.length) {
                ...
                this.frameWorkService.updateTerm(this.data.frameworkId, parent.category, parent.code, reguestBody).subscribe((res) => {
                    ...
                    if (counter === 0) {
                        ...
                        this.dialogClose({ term: Object.assign(Object.assign({}, this.selectedTerm), { associationProperties: { approvalStatus: 'Draft' } }), created: true });
                    }
                });
            }
        });
...
class ConnectorService {
    ...
    _drawLine(source, target, options = defaultConfig, sourceContainerId = undefined, targetContainerId = undefined) {
        ...
        const _options = Object.assign(Object.assign({}, defaultConfig), options);
        let _line;
        ...
        if (this.connectorMap) {
            for (const key in this.connectorMap) {
                ...
                if (this.connectorMap[key] && this.connectorMap[key].lines && this.connectorMap[key].lines.length > 0) {
                    ...
                    lines.forEach((element, index) => __awaiter(this, void 0, void 0, function* () {
                        (yield element.line) && element.line.remove();
...
class TaxonomyViewComponent {
    ...
    drawHeaderLine(len) {
        const options = Object.assign(Object.assign({}, defaultConfig), headerLineConfig);
        for (let i = 1; i <= len; i++) {
